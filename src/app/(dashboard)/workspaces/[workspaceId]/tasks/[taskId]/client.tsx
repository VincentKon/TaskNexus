...
const TaskIdClient = () => {
  ...
  if (!data) {
    return <PageError message="Task not found"></PageError>;
  }

  return (
    <div className="flex flex-col">
      <TaskBreadcrumbs project={data.project} task={data}></TaskBreadcrumbs>
      <DottedSeparator className="my-6"></DottedSeparator>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <TaskOverview task={data}></TaskOverview>
