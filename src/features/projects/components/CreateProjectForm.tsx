...
const CreateProjectForm = ({ onCancel }: CreateProjectFormProps) => {
  ...
  const form = useForm<z.infer<typeof createProjectSchema>>({
    resolver: zodResolver(createProjectSchema), // Don't omit workspaceId here
    defaultValues: {
      name: "",
      image: undefined,
      workspaceId: workspaceId, // Set workspaceId directly in defaultValues
    },
  });
  ...
  const onSubmit = (values: z.infer<typeof createProjectSchema>) => {
    const finalValues = {
      ...values,
      workspaceId, // Ensure workspaceId is included
      image: values.image instanceof File ? values.image : "", // Handle image properly
    };
